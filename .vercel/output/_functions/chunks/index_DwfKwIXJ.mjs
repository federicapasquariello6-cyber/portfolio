...
Ciao, sono Federica
</h1> <p class="text-xl text-gray-300 max-w-xl animate-fade-in">
Laureata in Ingegneria Energetica. Sto creando il mio primo portfolio con Astro e Tailwind.
</p> <div class="flex gap-4 pt-4 animate-fade-in"> <a href="/progetti" class="bg-white text-black px-6 py-3 rounded-lg hover:scale-105 transition">
Progetti
...
const $$file = "C:/Users/Utente/Desktop/Armonia/cd Desktop/src/pages/index.astro";
const $$url = "";
